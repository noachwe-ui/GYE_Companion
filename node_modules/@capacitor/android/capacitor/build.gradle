...
android {
    ...
    compileSdk 34= 34project.hasProperty('compileSdkVersion') ? rootProject.ext.compileSdkVersion 34: 36
    defaultConfig {
        minSdkVersion project.hasProperty('minSdkVersion') ? rootProject.ext.minSdkVersion : 24
        targetSdkVersion 34project.hasProperty('targetSdkVersion') ? rootProject.ext.targetSdkVersion 34: 36
        versionCode 1
        versionName "1.0"
